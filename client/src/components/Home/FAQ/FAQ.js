...
const FAQElement = ({ title, answer, active, setActive }) => {
    ...
    return (
        <div className="home-faq-element">
            <div onClick={() => setActive(title)} className="home-faq-title">
                <h3>{title}</h3>
                {/* <ChevronRightIcon className='home-faq-arrow' /> */}
                {active === title ? <ExpandMoreIcon className='home-faq-arrow' /> : <ChevronRightIcon className='home-faq-arrow' />}
            </div>
